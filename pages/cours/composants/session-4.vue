          ...
          <ul class="js-filter">
            <li data-tags="profess">
              ...
              <span class="flecheCours uk-accordion-title">
                ...
                <div class="uk-accordion-content">
                    <p>Ce cours initie l'étudiant aux rudiments de la gestion d’un projet multimédia. L’étudiant apprend à analyser les besoins liés à la réalisation du projet en termes de ressources humaines, matérielles et budgétaires. À cet effet, il est initié aux méthodes de gestion classiques, ainsi qu’aux méthodes dites « agiles », qu’il sera appelé à utiliser dans le cadre du cours « 582-5W5 : Projet Web en équipe ».</p>
                    <p>L'étudiant est amené à exploiter les fonctions d’un logiciel de gestion de projet en vue d’établir un échéancier de production et d’en faire le suivi. Le cours couvre également les aspects légaux relatifs à la réalisation d’un projet (droits d’auteurs, contrats, etc.). Enfin, l’étudiant développe sa capacité à écrire ou à répondre à un cahier des charges ainsi qu’à rédiger une offre de services professionnels.</p>
                </div>
            </li>
            ...
            <li data-tags="design ">
              ...
              <span class="flecheCours uk-accordion-title">
                Voir ce cours</span>
                <div class="uk-accordion-content">
                    <p>Dans ce cours, l'étudiant ayant un intérêt plus marqué pour la programmation a la possibilité d'approfondir les acquis des cours de la séquence Web en s'initiant à des technologies permettant de réaliser des applications riches du côté du client.</p>
                    <p>Il apprendra à utiliser un cadriciel côté client pour produire un site Web dynamique dont l'interface utilisateur réactive répond en temps réel aux modifications d'états des données de l'application. L’intégration d’effets de transition et d'animation dans l’interface-utilisateur est également couverte.</p>
                </div>
            </li>
            <li data-tags="scena art ">
              ...
              <span class="flecheCours uk-accordion-title">
                Voir ce cours</span>
                <div class="uk-accordion-content">
                    <p>Ce cours a pour but de permettre à l’étudiant d’approfondir les notions acquises dans le cours « 582-3M5 : Imagerie 3D » et de les appliquer dans la création de scènes élaborées. Le cours approfondit également les techniques de scénarisation couvertes dans les cours précédents.</p>
                    <p>L’étudiant apprend notamment les outils et techniques de modélisation organique ainsi que les techniques d’organisation des hiérarchies, de montage des systèmes d’articulation et d’animation. Enfin, l’étudiant apprend à maîtriser les techniques d’optimisation et d’exportation en vue de diffuser les productions 3D pour le Web ou pour des applications 3D en temps réel.</p>
                </div>
            </li>
          </ul>
      </section>
